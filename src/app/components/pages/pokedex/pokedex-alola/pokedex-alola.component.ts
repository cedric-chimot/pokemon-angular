...
@Component({
  selector: 'app-pokedex-alola',
  imports: [CommonModule, RouterModule, RegionSwitcherComponent, ButtonTopComponent],
  templateUrl: './pokedex-alola.component.html',
  styleUrl: './pokedex-alola.component.css'
})
export class PokedexAlolaComponent implements OnInit {
  @Input() region: number = 7;
