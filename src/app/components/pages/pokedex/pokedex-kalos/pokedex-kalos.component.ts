...
@Component({
  selector: 'app-pokedex-kalos',
  imports: [CommonModule, RouterModule, RegionSwitcherComponent, PaginationComponent, ButtonTopComponent],
  templateUrl: './pokedex-kalos.component.html',
  styleUrls: ['./pokedex-kalos.component.css']
})
export class PokedexKalosComponent {
@Input() region: number = 6;
